...
def run_2_phase_sim(inputs):
    ...
    with open(f'{sim_directory}/{input_dir}run_shanchen_sim.sh', 'w') as f:
        f.write(f'{simulation_command}')
...
def run_rel_perm_sim(inputs):
    ...
    with open(f'{sim_directory}/{input_dir}run_relperm_sim.sh', 'w') as f:
        f.write(f'{simulation_command}')
...
geom_file = f"../input/rg_theta30_phi30_micromodel.raw"
